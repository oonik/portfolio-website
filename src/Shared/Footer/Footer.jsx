    ...
    return (
        <footer className="footer items-center p-4 bg-neutral text-neutral-content">
            <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
                <Link to="https://github.com/oonik" target="_blank"><FaGithub className="text-4xl" /></Link>
                <Link to="https://www.linkedin.com/in/anik-sarkar-21457b244/" target="_blank"><FaLinkedin className="text-4xl" /></Link>
            </nav>
